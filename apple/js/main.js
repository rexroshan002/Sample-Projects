...
//   year:'2002',
//   getSummary:function(){
//     return `${book1.title} was written by ${book1.author} in the year ${book1.year}`;
//   }
// };
// const book2 = {
//   title:'Book Two',
...
//   year:'2005',
//   getSummary:function(){
//     return `${book2.title} was written by ${book2.author} in the year ${book2.year}`;
//   }
// };
...
function Book(title, author, year, getQ){
  this.title = title;
  this.author = author;
  this.year = year;
  this.getQ = function() {
...
const Book1 = new Book('Rex','Roshan','King');
const Book2 = new Book('Divya','Mitkare','Queen');
console.log(Book1.getQ);
